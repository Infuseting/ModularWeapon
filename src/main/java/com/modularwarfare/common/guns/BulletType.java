...
public class BulletType extends BaseType {
    ...
    public int DamagePerBellet;
    public int Penetration;
    public int ArmorDamage;
    public int Precision;
    public int recul;

    public int HemoragieLeger;

    public int HemoragieLourd;

    public int BulletIn;

    public int Efficacite1;

    public int Efficacite2;
    public int Efficacite3;
    public int Efficacite4;
    public int Efficacite5;
    public int Efficacite6;

...
public class ItemTourniquet extends Item implements IHasModel {
    public ItemTourniquet(String name)
    {
        ...
        if (entity instanceof EntityPlayer)
        {
            ...
            if (result != null && result.typeOfHit == RayTraceResult.Type.ENTITY && result.entityHit instanceof EntityLivingBase) {
                ...
                if (target instanceof EntityPlayer && target != player) {
                    ...
                    ModularWarfare.NETWORK.sendTo(new PacketHealPart(player, (EntityPlayer) player, 0, 1, 0), (EntityPlayerMP) player);
                }

...
public class PlayerSnapshot {
    ...
    public PlayerSnapshot(EntityPlayer p) {
        ...
        if (p.isSneaking()) {
            hitboxes.add(new PlayerHitbox(player, bodyAxes, new Vector3f(0F, 0F, 0F), new Vector3f(-0.25F, 0F, -0.15F), new Vector3f(0.5F, 0.5F, 0.3F), EnumHitboxType.BODY));
            ...
            hitboxes.add(new PlayerHitbox(player, bodyAxes, new Vector3f(0F, 0F, 0F), new Vector3f(-0.25F, 0F, -0.15F), new Vector3f(0.5F, 0.9F, 0.3F), EnumHitboxType.BODY));
        ...
        if (p.isSneaking()) {
            ...
            // Hitbox pour la jambe droite en position accroupie
            hitboxes.add(new PlayerHitbox(player, bodyAxes, new Vector3f(originXRight, 0.6F, originZRight), new Vector3f(-0.2F, -0.6F, -0.2F), new Vector3f(0.4F, 0.9F, 0.4F), EnumHitboxType.RIGHTLEG));

            // Hitbox pour la jambe gauche en position accroupie
            hitboxes.add(new PlayerHitbox(player, bodyAxes, new Vector3f(originXLeft, 0.6F, originZLeft), new Vector3f(-0.2F, -0.6F, -0.2F), new Vector3f(0.4F, 0.9F, 0.4F), EnumHitboxType.LEFTLEG));
        } else {
            hitboxes.add(new PlayerHitbox(player, bodyAxes, new Vector3f(originXRight, 1.0F, originZRight), new Vector3f(-0.2F, -0.6F, -0.2F), new Vector3f(0.4F, 1.3F, 0.4F), EnumHitboxType.RIGHTLEG));

            // Hitbox pour la jambe gauche en position normale
            hitboxes.add(new PlayerHitbox(player, bodyAxes, new Vector3f(originXLeft, 1.0F, originZLeft), new Vector3f(-0.2F, -0.6F, -0.2F), new Vector3f(0.4F, 1.3F, 0.4F), EnumHitboxType.LEFTLEG));

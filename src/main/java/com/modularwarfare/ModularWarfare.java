...
import com.modularwarfare.client.gui.GuiMainHudModified;
import com.modularwarfare.client.gui.GuiMainMenu;
import com.modularwarfare.common.*;
import com.modularwarfare.common.Thirst.IThirst;
import com.modularwarfare.common.Thirst.ThirstContainer;
import com.modularwarfare.common.Thirst.ThirstStorage;
...
public class ModularWarfare {
    ...
    public static final CreativeTabs Medical_TAB = new MedicalTab("Medical_Tab");
    public static final CreativeTabs Tools_TAB = new ToolsTab("Tools_Tab");
    public static final CreativeTabs Ressource_TAB = new RessourceTab("Ressource_Tab");
    // Main instance
    ...
    public void onPreInitialization(FMLPreInitializationEvent event) {
        ...
        if (FMLCommonHandler.instance().getSide().isClient()) {
            ACsGuiApi.registerStyleSheetToPreload(GuiMainMenu.CSSMAINMENU);
            //ACsGuiApi.registerStyleSheetToPreload(GuiHealthMenuLightBleed.CSSHEALTHMENU);

            MinecraftForge.EVENT_BUS.register(new GuiMainHudModified());
    ...
    public void onPostInitialization(FMLPostInitializationEvent event) {
        ...
        PROXY.init();
        CapabilityManager.INSTANCE.register(IHealth.class, new HealthStorage(), HealthContainer::new);
        CapabilityManager.INSTANCE.register(IThirst.class, new ThirstStorage(), ThirstContainer::new);

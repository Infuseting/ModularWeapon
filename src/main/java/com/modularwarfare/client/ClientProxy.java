...
public class ClientProxy extends CommonProxy {
    ...
    public static void IconSet() {
        try {
            InputStream iconStream = ClientProxy.class.getResourceAsStream("/assets/modularwarfare/logo.png");
            BufferedImage icon = ImageIO.read(iconStream);
            ByteBuffer[] icons = new ByteBuffer[] { convertToByteBuffer(icon) };
    ...
    {
        new DiscordRPCLoader();
        Display.setTitle("Chervonnoe - " + Minecraft.getMinecraft().getSession().getUsername());
        new ClientProxy().IconSet();
    ...
    public void setupLayers(RenderPlayer renderer) {
        ...
        renderer.addLayer(new RenderLayerHelmet(renderer, renderer.getMainModel().bipedBodyWear));
